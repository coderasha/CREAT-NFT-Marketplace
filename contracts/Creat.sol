...
import "./ICreat.sol";
import "./ICreatMarketAuction.sol";
import "./IMarketplaceSettings.sol";
import "./ICreatRoyaltyRegistry.sol";
import "./ICreatTokenCreatorRegistry.sol";
/**
 * Creat core contract.
*/

contract Creat is ERC1155, Ownable, ICreat {
    ...
    ICreatMarketAuction marketAuction;
    IMarketplaceSettings marketplaceSettings;
    ICreatRoyaltyRegistry royaltyRegistry;
    ICreatTokenCreatorRegistry tokenCreatorRigistry;
    ...
    function restore(address _oldAddress, uint256 _startIndex, uint256 _endIndex) external onlyOwner {
        Creat oldContract = Creat(_oldAddress);
    ...
    function setMarketAddresses(address _marketAuction, address _marketplaceSettings, address _tokenCreatorRigistry, address _royaltyRegistry) external onlyOwner {
        marketAuction = ICreatMarketAuction(_marketAuction);
        marketplaceSettings = IMarketplaceSettings(_marketplaceSettings);
        tokenCreatorRigistry = ICreatTokenCreatorRegistry(_tokenCreatorRigistry);
        royaltyRegistry = ICreatRoyaltyRegistry(_royaltyRegistry);
    }
